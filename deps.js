...
goog.addDependency("../../../picnet_closure_repo/src/deps.js", [], []);
goog.addDependency("../../../picnet_closure_repo/src/requirements.js", [], ['pn.closure.repo.demoscripts']);
goog.addDependency("../../../picnet_closure_repo/src/demos/datamanagerdemo.js", ['pn.demo.datamanagerdemo'], ['pn.data.DataManager', 'pn.MockAjaxProvider', 'pn.data.LocalStorageRepository']);
...
goog.addDependency("../../../picnet_closure_repo/src/demos/dbdemo.js", [], []);
goog.addDependency("../../../picnet_closure_repo/src/demos/demoscripts.js", ['pn.closure.repo.demoscripts'], ['pn.demo.daterangepickerdemo', 'pn.demo.tabslidemenudemo', 'pn.demo.datamanagerdemo']);
goog.addDependency("../../../picnet_closure_repo/src/demos/scripts.min.js", [], []);
...
goog.addDependency("../../../picnet_closure_repo/src/pn/IFrameDownload.js", ['pn.IFrameDownload'], ['goog.dom', 'goog.events', 'goog.net.EventType', 'goog.net.IframeIo']);
...
goog.addDependency("../../../picnet_closure_repo/src/pn/ui/edit/FieldBuilder.js", ['pn.ui.edit.FieldBuilder'], []);
...
goog.addDependency("../../../picnet_closure_repo/src/tests/all_tests.js", [], []);
goog.addDependency("../../../picnet_closure_repo/src/tests/GenericDataManagerTests.js", [], ['goog.array', 'goog.debug.Console', 'pn.MockAjaxProvider', 'pn.data.DefaultRepositoryFactory', 'pn.data.LocalStorageRepository', 'pn.data.WebSQLRepository', 'pn.data.IndexedDBRepository', 'pn.data.AbstractRepository', 'pn.data.DataManager']);
goog.addDependency("../../../picnet_closure_repo/src/tests/GenericRepositoryTests.js", [], ['goog.array', 'goog.debug.Logger', 'goog.debug.Console', 'pn.MockAjaxProvider', 'pn.data.AbstractRepository', 'pn.data.LocalStorageRepository', 'pn.data.WebSQLRepository', 'pn.data.GearsRepository', 'pn.data.IndexedDBRepository']);
goog.addDependency("../../../picnet_closure_repo/src/tests/MockAjaxProvider.js", ['pn.MockAjaxProvider'], ['goog.Uri.QueryData', 'goog.net.XhrIo', 'pn.data.IDataAjaxRequest']);
goog.addDependency("../../../picnet_closure_repo/src/tests/NodeServer.js", [], []);
goog.addDependency("../../../picnet_closure_repo/src/tests/RemoteDataProviderTests.js", [], ['goog.testing.jsunit', 'pn.Utils', 'pn.data.RemoteDataProvider', 'pn.data.InMemoryRepository', 'pn.data.AbstractRepository']);
goog.addDependency("../../../picnet_closure_repo/src/tests/update_all_tests.bin.js", [], []);
