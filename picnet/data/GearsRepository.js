...
goog.provide('picnet.data.GearsRepository');
 ...
 */
picnet.data.GearsRepository = function(databaseName) {
  picnet.data.AbstractSQLRepository.call(this, databaseName);
  this.log.fine('using the picnet.data.GearsRepository');
};
goog.inherits(picnet.data.GearsRepository, picnet.data.AbstractSQLRepository);
 ...
 * @type {string}
 */
picnet.data.GearsRepository.GOOGLE_GEARS_SUPPORT_URL =
 ...
 * @type {Object}
 */
picnet.data.GearsRepository.prototype.db_;


/** @inheritDoc */
picnet.data.GearsRepository.prototype.isSupported = function() {
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.db = function() {
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.init =
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.saveList =
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.clearEntireDatabase =
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.execute =
 ...
 */
picnet.data.GearsRepository.installGears = function(callback, handler) {
  picnet.data.GearsRepository.setUpGreasFactory();
...
/**
 */
picnet.data.GearsRepository.setUpGreasFactory = function() {
...
/** @inheritDoc */
picnet.data.GearsRepository.prototype.disposeInternal = function() {
  picnet.data.GearsRepository.superClass_.disposeInternal.call(this);
