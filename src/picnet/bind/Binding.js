;
goog.provide('picnet.bind.Binding');
...
/**
 * @constructor
 * @param {!Array.<picnet.bind.Source>} sources
 * @param {!Array.<picnet.bind.Target>} targets 
 */
picnet.bind.Binding = function(sources, targets) {
...
goog.scope(function() {
  ...
  var b = picnet.bind.Binding;
  var bp = picnet.bind.Binding.prototype;
