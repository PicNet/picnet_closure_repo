;
goog.provide('picnet.bind.Source');
 ...
 * @param {Object=} ctx
 */
picnet.bind.Source = function(getter, ctx) {
  goog.events.EventTarget.call(this);
  
  this.getter_ = getter;
  this.ctx_ = ctx;
};
goog.inherits(picnet.bind.Source, goog.events.EventTarget);

goog.scope(function() {

  var s = picnet.bind.Source;
  var sp = picnet.bind.Source.prototype;
