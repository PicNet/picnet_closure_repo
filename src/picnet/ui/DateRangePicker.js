...
goog.provide('picnet.ui.DateRangePicker');
 ...
 * @constructor
 */
picnet.ui.DateRangePicker = function(opt_datePickerFrom, opt_datePickerTo, 
...
goog.inherits(picnet.ui.DateRangePicker, goog.ui.Component);
 ...
 */
picnet.ui.DateRangePicker.prototype.setFirstWeekday = function(wday) {
...
/** @inheritDoc */
picnet.ui.DateRangePicker.prototype.createDom = function() {
  picnet.ui.DateRangePicker.superClass_.createDom.call(this);
  this.getElement().className = goog.getCssName('picnet-daterangepicker');
};


/** @inheritDoc */
picnet.ui.DateRangePicker.prototype.enterDocument = function() {
  picnet.ui.DateRangePicker.superClass_.enterDocument.call(this);
 ...
 *    change event.
 */
picnet.ui.DateRangePicker.prototype.listenToPickers = function(listen) {
  if (listen) {
 ...
 */
picnet.ui.DateRangePicker.prototype.showHideFromToLabels_ = function() {
...
/** @inheritDoc */
picnet.ui.DateRangePicker.prototype.disposeInternal = function() {
  picnet.ui.DateRangePicker.superClass_.disposeInternal.call(this);
  if (this.popup_) {
    this.popup_.dispose();
    this.popup_ = null;
  }
...
/** @inheritDoc */
picnet.ui.DateRangePicker.prototype.canDecorate = function(element) {
  return false;
};
 ...
 */
picnet.ui.DateRangePicker.prototype.getDatePickerFrom = function() {
 ...
 * @return {goog.ui.DatePicker} The date picker instance.
 */
picnet.ui.DateRangePicker.prototype.getDatePickerTo = function() {
 ...
 */
picnet.ui.DateRangePicker.prototype.getEmptyText = function() {
 ...
 *     selected.
 */
picnet.ui.DateRangePicker.prototype.setEmptyText = function(emptyText) {
 ...
 *    of the date pickers.
 */
picnet.ui.DateRangePicker.prototype.getShowFromAndToLabels = function() {
 ...
 */
picnet.ui.DateRangePicker.prototype.setShowFromAndToLabels =
 ...
 */
picnet.ui.DateRangePicker.prototype.getDateRangeFrom = function() {
 ...
 */
picnet.ui.DateRangePicker.prototype.getDateRangeTo = function() {
 ...
 */
picnet.ui.DateRangePicker.prototype.setDateRange = function(from, to) {
 ...
 */
picnet.ui.DateRangePicker.prototype.setAllowedDateRange = function(from, to) {
 ...
 */
picnet.ui.DateRangePicker.prototype.getLastTarget = function() {
 ...
 */
picnet.ui.DateRangePicker.prototype.detach = function(element) {
 ...
 */
picnet.ui.DateRangePicker.prototype.showPopup = function(element) {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.showPopup_ = function(event) {
 ...
 * Hides this popup.
 */
picnet.ui.DateRangePicker.prototype.hidePopup = function() {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.clearRange_ = function() {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.onDateChanged_ = function(event) {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.setLabelText_ = function(from, to) {
  if (this.dateFormat_) {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.highlightDateRange_ = function(from, to) {
 ...
 * @private
 */
picnet.ui.DateRangePicker.prototype.highlightDateRangeImpl_ = function(from, to,
    picker) {
