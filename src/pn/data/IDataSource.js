...
/**
 * @param {Array.<pn.data.EntityFactory>} types The entity types to load.
...
/**
 * @param {pn.data.EntityFactory} type The entity type to load.
 * @param {number} id The entity ID of the specified type to load.
 * @param {function(pn.data.Entity):undefined} callback A success callback that takes
