...
pn.ui.edit.FieldRenderers.readOnlyDateField =
    function(val, entity, parent, opt_search, opt_id) {
  if (opt_search === true) {
    return pn.ui.edit.FieldRenderers.dateRenderer(
        val, entity, parent, true, opt_id);
  }
